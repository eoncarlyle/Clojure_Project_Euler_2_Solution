...
(defn fib_max_n [fib_max n]
  ...
  ;;? I'm pretty sure I can use arity overloading to provide a default value to n,
  ;;? but I am unsure of how to best do this.
...
(defn sum_even_fib [fib_max]
  ...
  (def fib_vector (fib_vectorizer (fib_max_n fib_max 1)))
